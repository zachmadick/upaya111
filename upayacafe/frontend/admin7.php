...
<body>
  ...
  <!-- Home Button -->
    ...
    <div class="menu-section">
      ...
      <button class="active"><a href="admin7.php"><h3>WAFFLES</h3></a></button>
    ...
    <div class="product-grid" id="product-grid">
      <h3>WAFFLES</h3>
      <div class="items">
        <div class="item" data-name="Classic Maple" data-price="90">Classic Maple - 90</div>
        <div class="item" data-name="Chocolate" data-price="90">Chocolate - 90</div>
        <div class="item" data-name="Strawberry" data-price="90">Strawberry - 90</div>
        <div class="item" data-name="Blueberry" data-price="90">Blueberry - 90</div>
        <div class="item" data-name="Caramel" data-price="90">Caramel - 90</div>
        <div class="item" data-name="Peanut Butter" data-price="90">Peanut Butter - 90</div>
        <div class="item" data-name="Combo Waffle" data-price="100">Combo Waffle - 100</div>
        <div class="item" data-name="Extra Toppings" data-price="25">Extra Toppings - 25</div>
      </div>
    </div>
    </div>
