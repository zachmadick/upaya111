  ...
  <!-- Home Button -->
    ...
    <div class="menu-section">
      ...
      <div class="category-tabs">
        ...
        <button class="active"><a href="admin2.php"><h3>NON-COFFEE DRINKS</h3></a></button>
      ...
      <div class="items">
        <div class="item" data-name="Blueberry Latte" data-price="125">Blueberry Latte - 125</div>
        <div class="item" data-name="Strawberry Latte" data-price="125">Strawberry Latte - 125</div>
        <div class="item" data-name="Chocolate Lava Latte" data-price="135">Chocolate Lava Latte - 135</div>
        <div class="item" data-name="Black Forest Latte" data-price="150">Black Forest Latte - 150</div>
        <div class="item" data-name="Peach Latte" data-price="135">Peach Latte - 135</div>
        <div class="item" data-name="Mango Latte" data-price="135">Mango Latte - 135</div>
        <div class="item" data-name="Peach Mango Latte" data-price="125">Peach Mango Latte - 125</div>
        <div class="item" data-name="Passion Fruit Latte" data-price="130">Passion Fruit Latte - 130</div>
      </div>
    </div>
    </div>
