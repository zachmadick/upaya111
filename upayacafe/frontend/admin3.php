...
<body>
  ...
  <!-- Home Button -->
    ...
    <div class="menu-section">
      ...
      <button class="active"><a href="admin3.php"><h3>FRAPPE</h3></a></button>
    ...
    <div class="product-grid" id="product-grid">
      <h3>FRAPPE (NON-COFFEE)</h3>
      <div class="items">
        <div class="item" data-name="Chocolate Lava" data-price="165">Chocolate Lava - 165</div>
        <div class="item" data-name="Strawberry" data-price="165">Strawberry - 165</div>
        <div class="item" data-name="Blueberry " data-price="165">Blueberry - 165</div>
        <div class="item" data-name="Blueberry & Strawberry" data-price="165">Blueberry & Strawberry - 165</div>
        <div class="item" data-name="Passion Fruit" data-price="165">Passion Fruit - 165</div>
        <div class="item" data-name="Peach" data-price="165">Peach - 165</div>
        <div class="item" data-name="Peach Mango" data-price="175">Peach Mango - 175</div>
        <div class="item" data-name=">Black Forest" data-price="165">>Black Forest - 165</div>
        <div class="item" data-name="Matcha" data-price="175">Matcha - 175</div>
        <div class="item" data-name="Strawberry Matcha" data-price="165">Strawberry Matcha - 165</div>
        <div class="item" data-name="Blueberry Matcha" data-price="185">Blueberry Matcha - 185</div>
        <div class="item" data-name="Chocolate Lava" data-price="165">Blueberry Latte - 165</div>
        <div class="item" data-name="White Choco Matcha" data-price="155">Blueberry Latte - 155</div>
        <div class="item" data-name="Oreo " data-price="175">Oreo  - 175</div>
      </div>

      <h3>FRAPPE (COFFEE)</h3>
      <div class="items">
        <div class="item" data-name="Caramel Popcorn" data-price="165">Caramel Popcorn - 165</div>
        <div class="item" data-name="Java Chip Frappe" data-price="165">Java Chip Frappe - 165</div>
        <div class="item" data-name="Biscoff Frappe" data-price="165">Biscoff Frappe - 165</div>
      </div>
    </div>
    </div>
