...
<body>
  ...
  <!-- Home Button -->
    ...
    <div class="category-tabs">
      ...
      <button class="active"><a href="admin9.php"><h3>PASTA</h3></a></button>
    ...
    <div class="product-grid" id="product-grid">
      <h3>PASTA</h3>
      <div class="items">
        <div class="item" data-name="Baked Mac" data-price="195">Baked Mac - 195</div>
        <div class="item" data-name="Creamy Carconara" data-price="195">Creamy Carconara - 195</div>
      </div>
    </div>
    </div>
